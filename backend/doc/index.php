                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Number or Email</label>
                                        <input class="form-control" name="doc_number" type="text" id="emailaddress" required="" placeholder="Enter your email address or number">
                                    </div>
