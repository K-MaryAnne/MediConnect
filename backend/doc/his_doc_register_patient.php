<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$query="insert into his_patients (pat_fname, pat_lname, pat_dob, pat_number, pat_phone, pat_addr) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $pat_fname, $pat_lname, $pat_dob, $pat_number, $pat_phone, $pat_addr);
			$stmt->execute();
