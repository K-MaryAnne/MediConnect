...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_dob=?, pat_phone=?, pat_addr=?, WHERE pat_number=?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $pat_fname, $pat_lname, $pat_dob,  $pat_phone, $pat_addr, $pat_number);
			$stmt->execute();
