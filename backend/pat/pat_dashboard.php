            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Your Details</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-hover table-centered m-0">
                                        ...
                                        <?php
                                        // SQL query to get patient details
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="pat_view_single_patient.php?pat_id=<?php echo $row->pat_id; ?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php } ?>
