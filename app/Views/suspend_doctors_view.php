...
<div class="container mt-5">
        ...
        <?php endif; ?>
        <table id="suspendedDoctors" class="table table-striped nowrap" style="width:100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>First Name</th>
            ...
            <tbody>
                <?php foreach ($suspended_doctors as $doctor) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= site_url('DoctorCrudController/restore_doctor/' . $doctor->User_ID) ?>" class="btn btn-success">Restore</a>
