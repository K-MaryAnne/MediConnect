...
<div class="container mt-5">
        ...
        <?php endif; ?>
        <table id="suspendedNurses" class="table table-striped nowrap" style="width:100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>First Name</th>
            ...
            <tbody>
                <?php foreach ($suspended_nurses as $nurse) : ?>
                    <tr>
                        <td><?= $nurse->User_ID ?></td>
                        ...
                        <td>
                            <a href="<?= site_url('NurseCrudController/restore_nurse/' . $nurse->User_ID) ?>" class="btn btn-success">Restore</a>
