...
<head>
    ...
    <title>Edit Nurse - Mediconnect Admin Dashboard</title>
    <!-- ======= Styles ====== -->
    ...
    <?php endif; ?>
                <form action="<?= base_url('nurse/update/' . $nurse->User_ID) ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Specialisation" name="Specialisation" value="<?= $nurse->Specialisation ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="Years_of_Experience">Years of Experience</label>
                        <input type="number" class="form-control" id="Years_of_Experience" name="Years_of_Experience" value="<?= $nurse->Years_of_Experience ?>" required>
                    </div>
                    <div class="form-group">
