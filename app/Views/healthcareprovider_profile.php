        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Subcounty/Town</label><input type="text" class="form-control" placeholder="enter subcounty/town" value=""></div>
                    <div class="col-md-12"><label class="labels">Area/Ward</label><input type="text" class="form-control" placeholder="enter area/ward" value=""></div>
    ...
    <div class="d-flex">
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">Additional Details on Specialisations</label><input type="text" class="form-control" placeholder="additional details" value=""></div>
            </div>
        </div>
    </div>
</div>
